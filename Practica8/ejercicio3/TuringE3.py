...
if __name__ == "__main__":
    ...
    # all A's and accept
    m = TuringMachine("00", [7,8,9,10]) 

#-----------------------------------
#si la cadena inicia con "0"
m.addTransition(0,'0',1,'0','R')
m.addTransition(1,'0',3,'0','R')
m.addTransition(3,'_',7,'_00','R')

#-----------------------------------
#Si la cadena empieza con "1"
#m.addTransition(0,'1',2,'1','R')
#m.addTransition(2,'0',5,'0','R')
#m.addTransition(5,'_',9,'_01','R')
#m.addTransition(2,'1',6,'1','R')
#m.addTransition(6,'_',10,'_10','R')

#------------------------------------
m.addTransition(0,'_',3,'_','L')
